...
export const slides = [
    ...
    { url: 'https://i.ibb.co/5nvrphL/b.png' }
  ]; 

  export const lastProducts = [
    {
      name: 'Malbec Rosé',
      url: 'https://novili.com.co/blog/wp-content/uploads/2020/09/portadas-kaiken-actualizacion.jpg',
      price: 1900
    },
    {
      name: 'Arroz Gallo',
      url: 'https://grupoberro.com/media/works/arroz-gallo-2013/NYZTLUxUPJYE8uOxNLPyeeOmtLYeeycMzs5.jpg',
      price: 450
    },
    {
      name: 'Alimento Sabrositos',
